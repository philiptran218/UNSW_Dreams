...
def test_invite_duplicate_uid(lear_database, user_1, user_2, channel_1):
...
def test_invite_valid_inputs(clear_data, user_1, user_2, channel_1):
...
def test_invite_global_owner_allowed(clear_data, user_1, user_2, user_3, channel_2):
...
def test_invite_global_owner_invited(clear_data, user_1, user_2, channel_2):
    requests.post(config.url + 'channel/invite/v2', json={
        'token': user_2['token'],
        'channel_id': channel_2,
