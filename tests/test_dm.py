...
def test_dm_details_v1_valid(clear_data, test_dm_id, test_user1_token):
    assert(dm_details_v1(test_user1_token, test_dm_id) == expected_output_details_v1())

def test_dm_details_v1_invalid_InputError(clear_data, test_user1_token):
    with pytest.raises(InputError):
        dm_details_v1(test_user1_token, INVALID_DM_ID)

def test_dm_details_v1_invalid_AccessError(clear_data, test_dm_id, test_user2_token):
    with pytest.raises(AccessError):
        dm_details_v1(test_user2_token, test_dm_id)

def test_dm_details_v1_invalid_token(clear_data, test_dm_id):
    with pytest.raises(AccessError):
...
def test_dm_list_v1_valid(clear_data, test_user1_token, test_user2_u_id):
...
def test_dm_create_v1_valid_two(clear_data, test_dm, test_user1_token, test_user2_u_id):
    assert(dm_create_v1(test_user1_token, test_user2_u_id) == expected_output_create_v1())
