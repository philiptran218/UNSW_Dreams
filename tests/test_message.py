...
from src.channel import channel_messages_v1, channel_join_v1, channel_invite_v1, channel_leave_v1
from src.message import message_send_v1, message_edit_v1, message_remove_v1, message_pin_v1, message_unpin_v1
...
def test_message_unpin_another_user_in_dm(clear_database, user1, user2, channel1, dm1, message1, message2):
    dm_invite_v1(user1['token'], dm1, user2['auth_user_id'])
    message_pin_v1(user1['token'], message2)
    message_unpin_v1(user2['token'], message2)
    dm_messages = dm_messages_v1(user1['token'], dm1, 0)
